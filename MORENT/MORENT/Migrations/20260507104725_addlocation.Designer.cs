...
namespace MORENT.Migrations
{
    ...
    [Migration("20260507104725_addlocation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MORENT.Models.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MORENT.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MORENT.Models.Payment", b =>
                {
                    b.HasOne("MORENT.Models.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("MORENT.Models.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
